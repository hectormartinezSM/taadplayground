        ...
        <CardContent className="p-12">
          <div className="flex flex-col items-center justify-center gap-8 text-center">
            ...
            <div className="space-y-4">
              ...
              {!isLoading && (
                <div className="flex items-center justify-center gap-2 text-base text-foreground/80 font-medium bg-[#4A9FFF]/10 rounded-lg px-5 py-4 border border-[#4A9FFF]/20">
