      ...
      <Card className="hover:shadow-lg transition-shadow">
        <CardContent className="p-12">
          <div className="flex flex-col items-center justify-center gap-8 text-center">
            {/* Icon */}
            <div className="flex h-24 w-24 items-center justify-center rounded-full bg-[#525199]/10 shadow-sm">
              {isLoading ? (
                <Loader2 className="h-12 w-12 animate-spin text-[#525199]" />
              ) : (
                <Landmark className="h-12 w-12 text-[#525199]" />
              )}
            </div>
            ...
            <div className="space-y-4">
              <h2 className="text-3xl font-bold text-foreground whitespace-nowrap text-center">
                {isLoading ? "Iniciando demo..." : "DOCMA | Clasificación y extracción documental"}
              </h2>
              <p className="text-lg text-muted-foreground leading-relaxed text-center max-w-lg mx-auto">
                {isLoading
                  ...
                  : "Experimenta el poder de DOCMA para clasificar y extraer información de documentos automáticamente."}
              </p>
              {!isLoading && (
                <div className="flex items-center justify-center gap-2 text-base text-foreground/80 font-medium bg-[#FF6200]/10 rounded-lg px-5 py-4 border border-[#FF6200]/20">
                  <FileText className="h-6 w-6 text-[#FF6200] flex-shrink-0" />
                  <span className="text-muted-foreground whitespace-nowrap">Caso de uso:</span>
                  <span className="text-[#FF6200] font-semibold whitespace-nowrap">
            ...
            {!isLoading && (
              <Button
                size="lg"
                className="shadow-md hover:shadow-lg text-lg px-8 py-6 h-auto bg-[#FF6200] hover:bg-[#E55800] text-white"
